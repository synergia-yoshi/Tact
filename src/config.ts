...
export function loadConfig(): HermesConfig {
  ...
  return {
    ...
    maxCandidatesPerRun: envNumber("MAX_CANDIDATES_PER_RUN", 40),
    maxDeliveriesPerRun: envNumber("MAX_DELIVERIES_PER_RUN", 4),
    ttpScoreThreshold: envNumber("TTP_SCORE_THRESHOLD", 15),
    llmBatchSize: envNumber("LLM_BATCH_SIZE", 8),
    ...
    maxBodyCharsPerCandidate: envNumber("MAX_BODY_CHARS_PER_CANDIDATE", 3000),
